/* ══════════════════════════════════════════════════════════════
   AwakerHz — dizionari di traduzione
   L'INGLESE è il testo di default scritto direttamente nell'HTML
   (ottimo per SEO e come fallback). Qui ci sono solo IT ed ES.
   Per aggiungere/modificare una lingua basta editare questo file.
   Chiavi: usate come data-i18n="chiave" negli elementi HTML.
   ══════════════════════════════════════════════════════════════ */
window.I18N = {
  ...
  it: {
    ...
    /* home — esplora */
    "home.explore.label": "Esplora",
    "home.explore.title": "L'Universo AwakerHz",
    ...
    "nl.title": "Unisciti alla Community",
    "nl.sub": "Ricevi le notifiche delle nuove frequenze, contenuti esclusivi e guide alla guarigione. Niente spam · solo segnale puro.",
    "nl.placeholder": "latua@email.com",
    "nl.button": "Iscriviti",
    "nl.success": "✓  Sei dentro. Benvenuto in AwakerHz.",
    ...
    "store.title": "Store AwakerHz",
    "store.sub": "Strumenti, merch e risorse per accompagnare il tuo percorso di guarigione.",
    "store.notice.title": "Store in apertura",
    "store.notice.text": "Lo store sta arrivando. Presto troverai prodotti e risorse selezionate.",

    /* pagina Salute & Cibo */
    "health.eyebrow": "Benessere",
    ...
    "ph.soon": "In arrivo",
    "ph.title": "Titolo in arrivo",
    "ph.text": "Questo spazio è pronto. Nuovi contenuti in arrivo."
  },
  ...
  es: {
    ...
    /* home — explora */
    "home.explore.label": "Explora",
    "home.explore.title": "El Universo AwakerHz",
    ...
    "nl.title": "Únete a la Comunidad",
    "nl.sub": "Recibe avisos de nuevos lanzamientos de frecuencias, contenido exclusivo y guías de sanación. Sin spam · solo señal pura.",
    "nl.placeholder": "tu@email.com",
    "nl.button": "Suscríbete",
    "nl.success": "✓  Estás dentro. Bienvenido a AwakerHz.",
    ...
    "store.title": "Tienda AwakerHz",
    "store.sub": "Herramientas, merch y recursos para acompañar tu camino de sanación.",
    "store.notice.title": "Tienda próximamente",
    "store.notice.text": "La tienda está en camino. Pronto encontrarás productos y recursos seleccionados.",

    /* página Salud & Comida */
    "health.eyebrow": "Bienestar",
    ...
    "ph.soon": "Próximamente",
    "ph.title": "Título próximamente",
    "ph.text": "Este espacio está listo. Pronto habrá nuevo contenido."
  }
};
